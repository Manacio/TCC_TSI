...
class LoginPageTec extends StatefulWidget {
  const LoginPageTec({super.key});

  @override
  State<LoginPageTec> createState() => _LoginPageTecState();
}


class _LoginPageTecState extends State<LoginPageTec> {
  ...
  void _realizarLogin() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.push(
        context,
        FadePageRoute(page: const HomePageTec()),
      );
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const RegisterPageTec(),
                      ),
                    );
                  },
